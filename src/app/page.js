...
function Home({ searchParams }) {
	return (
		<main className="flex min-h-screen flex-col items-center bg-black">
			...
			<section className="my-2 md:my-12"></section>
			...
			<div className="flex items-center place-content-around px-12 md:px-40 w-full">
				<div className="flex flex-col items-center w-1/5">
					<img src='/eco.png' className="p-2 h-28 w-28" />
				...
				<div className="flex flex-col items-center w-1/5">
					<img src='/prolong.png' className="p-3 h-28 w-28" />
					<p>Prolong Charcoal</p>
					<p className="font-thin text-center line-clamp-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
				</div>
				<div className="flex flex-col items-center w-1/5">
					<img src='/deliver.png' className="h-28 w-28" />
					<p>Fast Delivery</p>
					<p className="font-thin text-center line-clamp-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
				</div>
				<div className="flex flex-col items-center w-1/5">
					<img src='/logo.png' className="h-28 w-28 p-3" />
					<p>Good Packaging</p>
					<p className="font-thin text-center line-clamp-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
				</div>
			</div>

			<section className="my-6 md:my-20" id='product'></section>

			<div className="flex flex-col items-center w-8/12 h-60v">
				...
				{/* mobile */}
				<div className="flex md:hidden mt-2 md:mt-12 items-center gap-3 place-content-between">
					<div>a</div>
					<div>b</div>
					<div>c</div>
				</div>
			...
			<section className="my-4 md:my-20" id='contact'></section>

			<div className="grid grid-cols-1 items-center md:grid-cols-2 px-12 w-2/3 h-full">
				...
				<div className="relative col-span-1 text-end">
			...
			<div className="flex flex-col items-center font-thin px-12 md:px-80 w-full h-full">
